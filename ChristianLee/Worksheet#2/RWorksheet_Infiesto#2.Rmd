...
ForbesData <- data.frame(PowerRanking, CelebrityName, Pay)
print(ForbesData)
...
ForbesData[ForbesData$CelebrityName == "J.K. Rowling", "PowerRanking"] <- 15
ForbesData[ForbesData$CelebrityName == "J.K. Rowling", "Pay"] <- 90
print(ForbesData)
